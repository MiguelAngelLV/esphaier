 ...
 ESP Haier is a project to use a ESP8266 (I did not test with ESP32) to control Haier Air Conditioner with wifi wodule supoort with ESPHome and Home Assisant.
